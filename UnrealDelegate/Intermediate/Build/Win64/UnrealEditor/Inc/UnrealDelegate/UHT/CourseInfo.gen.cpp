...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UCourseInfo_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UCourseInfo_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UCourseInfo_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealDelegate_Source_UnrealDelegate_CourseInfo_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealDelegate_Source_UnrealDelegate_CourseInfo_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCourseInfo, UCourseInfo::StaticClass, TEXT("UCourseInfo"), &Z_Registration_Info_UClass_UCourseInfo, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCourseInfo), 3533405099U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealDelegate_Source_UnrealDelegate_CourseInfo_h_3479084743(TEXT("/Script/UnrealDelegate"),
		Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealDelegate_Source_UnrealDelegate_CourseInfo_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealDelegate_Source_UnrealDelegate_CourseInfo_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
