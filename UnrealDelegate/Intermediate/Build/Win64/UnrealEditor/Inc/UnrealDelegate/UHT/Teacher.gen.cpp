...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTeacher_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UTeacher_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_ULessonInterface_NoRegister, (int32)VTABLE_OFFSET(UTeacher, ILessonInterface), false },  // 2545877862
		};
	...
	UTeacher::~UTeacher() {}
	struct Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealDelegate_Source_UnrealDelegate_Teacher_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealDelegate_Source_UnrealDelegate_Teacher_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTeacher, UTeacher::StaticClass, TEXT("UTeacher"), &Z_Registration_Info_UClass_UTeacher, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTeacher), 2297749314U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealDelegate_Source_UnrealDelegate_Teacher_h_551614952(TEXT("/Script/UnrealDelegate"),
		Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealDelegate_Source_UnrealDelegate_Teacher_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealDelegate_Source_UnrealDelegate_Teacher_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
