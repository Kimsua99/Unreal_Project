...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UStudent_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UStudent_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_ULessonInterface_NoRegister, (int32)VTABLE_OFFSET(UStudent, ILessonInterface), false },  // 2072699270
		};
	...
	UStudent::~UStudent() {}
	struct Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealComposition_Source_UnrealComposition_Student_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealComposition_Source_UnrealComposition_Student_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStudent, UStudent::StaticClass, TEXT("UStudent"), &Z_Registration_Info_UClass_UStudent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStudent), 623767315U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealComposition_Source_UnrealComposition_Student_h_1991216796(TEXT("/Script/UnrealComposition"),
		Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealComposition_Source_UnrealComposition_Student_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealTest_Unreal_Study_UnrealComposition_Source_UnrealComposition_Student_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
